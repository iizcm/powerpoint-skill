...
cp -r productivity/powerpoint ~/.hermes/skills/productivity/powerpoint/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/powerpoint-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/powerpoint-skill.git ~/.hermes/skills/productivity/powerpoint/
```
...
```text
skill_view(name="productivity/powerpoint")
```
...
```text
Use the powerpoint skill to <describe your specific task here>
```
...
```text
Gunakan skill powerpoint untuk <deskripsikan tugas spesifik Anda di sini>
```
